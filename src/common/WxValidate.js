/**
 * @description: 表单验证方法
 * @copy https://github.com/skyvow/wx-extend/blob/master/src/assets/plugins/wx-validate/WxValidate.js
 * @doc  https://github.com/skyvow/wx-extend/blob/master/docs/components/validate.md
 * @Author: fusy
 * @Date: 2019-06-21 15:48:01
 * -----
 * @Modified By: fusy
 * @Last Modified: 2019-06-21 15:52:17
 * HISTORY:
 * Date  	By	Comments
 * ------	---	---------------------------------------------------------
 */
